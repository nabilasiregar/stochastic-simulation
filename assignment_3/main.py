...
def main():
    ...
    testing_length = calculate_path_length(paths, nodes)
    ...
    # Display results
    print(f'Best path length found: {best_length}, provided path length: {testing_length}, found in {iterations} iterations')
